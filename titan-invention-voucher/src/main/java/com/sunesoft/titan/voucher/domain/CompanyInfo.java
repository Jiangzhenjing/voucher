...
public class CompanyInfo extends IEntity {
     ...
     * 是否发放服务券
     */
    private Boolean isHandVoucher = false;
    ...
    public Boolean getHandVoucher() {
        return isHandVoucher;
    }

    public void setHandVoucher(Boolean handVoucher) {
        isHandVoucher = handVoucher;
    }

    public ServiceVoucher getServiceVoucher() {
        return serviceVoucher;
    }

    public void setServiceVoucher(ServiceVoucher serviceVoucher) {
